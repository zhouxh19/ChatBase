<template>
  <div class="columnSC" style="width: 100%">
    <div class="rowBC" style="padding: 20px; width: 100%">
      ...
      <el-button v-if="basicStore.isAdmin" ref="addKnowledgeRef" size="default" plain type="primary" @click="onCreateKnowledgeClick">创建知识库</el-button>
    </div>
...
<!--            <el-tag size="small" style="margin-bottom: 5px">{{vs_item.file_count}} files</el-tag>-->
    ...
    >
      <el-tour-step :target="addKnowledgeRef?.$el" title="Add Knowledge">
        <div>You can add test knowledge here.</div>
      </el-tour-step>
    </el-tour>
...
const addKnowledgeRef = ref<ButtonInstance>()
...
const getKnowledgeList = async () => {
  ...
  tourOpen.value = knowledge.list.length === 0
}
