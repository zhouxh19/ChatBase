...
def get_loader(loader_name: str, file_path: str, loader_kwargs: Dict = None):
    ...
    try:
        if loader_name in ["RapidOCRPDFLoader", "RapidOCRLoader", "FilteredCSVLoader",
                           "RapidOCRDocLoader", "RapidOCRPPTLoader", "JSONLoader"]:
    ...
    if loader_name == "UnstructuredFileLoader":
    ...
    elif loader_name == "CSVLoader" or loader_name == "TextLoader":
        ...
        loader_kwargs.setdefault("content_key", "page_content")
...
def make_text_splitter(
    ...
    try:
        if splitter_name == "MarkdownHeaderTextSplitter":  # MarkdownHeaderTextSplitter特殊判定
            ...
            if text_splitter_dict.get(splitter_name):
...
class KnowledgeFile:
                ...
                for doc in self.docs:
                    if hasattr(doc, 'metadata'):
                        ...
                        if 'original_answer' in metadata:
                            metadata['llm_content'] = str(metadata['original_answer'])
                    if 'page_content' in doc:
                        doc['0'] = str(doc['page_content'])
        return self.docs
    ...
    def docs2texts(
        ...
        print(f"正在使用：{self.text_splitter_name} 对 {self.filepath}进行分片，请等待。")
    ...
    def convert_str_to_json(self, content):
        try:
            json.loads(content)
            return content
...
if __name__ == "__main__":
    ...
    kb_file = KnowledgeFile(
        ...
        knowledge_base_name="th_document")
