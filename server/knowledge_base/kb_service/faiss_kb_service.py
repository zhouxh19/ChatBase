...
if __name__ == '__main__':
    faissService = FaissKBService("create_test")
    faissService.add_doc(KnowledgeFile("AI4DB-数据库自治运维_1.json", "create_test"))
    faissService.delete_doc(KnowledgeFile("AI4DB-数据库自治运维_1.json", "create_test"))
    faissService.do_drop_kb()
    print(faissService.search_docs("AI4DB"))
